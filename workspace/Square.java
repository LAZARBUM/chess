...
public class Square extends JComponent {
    ...
    private Piece occupyingPiece;  // Changed from KingKnight to Piece
    ...
    public Piece getOccupyingPiece() {  // Updated to return Piece
    ...
    public void put(Piece p) {  // Updated to accept Piece
